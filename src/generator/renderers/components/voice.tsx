...
export default function DiscordVoiceMessage({ attachment }: { attachment: Attachment }) {
  ...
  if (waveformBars.length === 0) {
    waveformBars = [40, 80, 60, 120, 90, 150, 70, 200, 130, 80, 170, 50, 90, 140, 60, 180, 100, 70, 160, 50, 110, 130, 80, 60, 140, 90, 170, 70, 50, 120, 80, 40];
  }
    ...
    <div className="discord-voice-message" slot="attachment">
      ...
      <div className="discord-voice-waveform">
        {waveformBars.map((val, i) => {
          ...
          return (
            <div
              key={i}
              className="discord-voice-waveform-bar"
      ...
      <div className="discord-voice-volume">
        <svg viewBox="0 0 24 24" width="20" height="20">
          ...
          <path fill="currentColor" d="M14 3.2V5.3C16.9 6.1 19 8.8 19 12C19 15.2 16.9 17.9 14 18.7V20.8C18.1 19.9 21 16.3 21 12C21 7.7 18.1 4.1 14 3.2Z" />
        </svg>
      </div>
    </div>
  );
